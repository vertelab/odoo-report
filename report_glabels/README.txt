...
Download and Install the barcode package from groovy (using dpkg -i):
    ...
    * barcode (0.99-4) [universe] https://ubuntu.pkgs.org/20.10/ubuntu-universe-arm64/barcode_0.99-4_arm64.deb.html
...
install dependencies:
    ...
    * sudo apt install autotools-dev autoconf-archive cdbs debhelper intltool gtk-doc-tools yelp-tools libgtk-3-dev librsvg2-dev libcairo2-dev libpango1.0-dev libebook1.2-dev libiec16022-dev
